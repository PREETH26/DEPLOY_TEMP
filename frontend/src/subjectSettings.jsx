...
// import arrow from "./assets/arrow_back.png"; // Adjust the path as needed
...
//     // Fetch subject data, class data, user profile, and all members on mount
//     useEffect(() => {
...
//     // Compute availableMembersToAdd
//     const availableMembersToAdd = useMemo(() => {
//         if (!allMembers || !subjectData || !classData) return [];
//         // Members who are in the class but not in the subject group
...
//     // Add selected members to the subject group
...
//     // Remove selected members from the subject group
...
//     // console.log(subjectMembers);

//     // Determine if the user has permission to edit (Admin, HOD, or faculty of the subject)
//     const canEdit =
//         profile.role === "Admin" ||
//         profile.role === "HOD" ||
...
//                                             ))}
//                                             {subjectMembers.length === 0 && (
//                                                 <li className="p-2 text-gray-500">No members to remove</li>
//                                             )}
//                                         </ul>
