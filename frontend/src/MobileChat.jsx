...
//   // Swipe handlers - Applied only when in chat view
...
//   const handleBack = () => {
//     if (!selectedChat) {
//       // On contacts page, do nothing
//       return;
//     }
//     // Otherwise, navigate back one step in history
//     navigate(-1);
//   };
...
//     setPreviewFileName(null);
//     setIsPreviewOpen(false);
//     setZoom(false); // Reset zoom when closing
//   };
...
//               <div className="relative bg-white p-4 rounded-lg max-w-3xl w-[90%] max-h-[90vh]">
//                 <div className="flex justify-between items-center mb-4 break-all text-center">
//                   <h2 className="text-md font-semibold mr-10">Image Preview: {previewFileName}</h2>
//                   <button
//                     onClick={() => downloadFile(previewImageUrl, previewFileName)}
