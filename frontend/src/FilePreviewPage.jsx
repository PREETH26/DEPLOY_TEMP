...
// Custom CSS for styling the DOCX preview
const docxStyles = `
  .docx-preview {
...
function FilePreviewPage() {
  ...
  // Use the proxy endpoint to fetch the file
  useEffect(() => {
    if (fileUrl) {
  ...
  // Load DOC file content (for .doc and .docx)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen p-4">
      {/* Inject custom styles for DOCX preview */}
